...
/********************************/
-- Assumes that table #SavedSearchDocuments exists
/********************************/


--USE tempdb
CREATE PROCEDURE [dbo].[usp_SN_GetGraphGeneration15Filter] @SenderEntityID int = -1, @RecipientEntityID int = -1,  @MaximumParticipants int = 2000000000, @SavedSearch int = -1
AS

	/*
	DECLARE @SenderEntityID int = -1
