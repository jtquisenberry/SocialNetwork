...
--USE tempdb
CREATE PROCEDURE [dbo].[usp_SN_GetGraphGeneration20Filter] @Levels int = 2, @SenderEntityID int = -1, @RecipientEntityID int = -1,  @MaximumParticipants int = 2000000000, @SavedSearch int = -1
AS
